...
const RPC_DEFINITIONS: Record<string, RpcDefinition> = {
  ...
  create_location: {
    params: ["loc_name", "loc_type", "parent_location", "loc_description", "loc_icon_name", "loc_image_path"],
  },
  update_location: {
    params: ["loc_id", "loc_name", "loc_type", "parent_location", "loc_description", "loc_icon_name", "loc_image_path"],
  },
  move_location: { params: ["loc_id", "new_parent"] },
  delete_location: { params: ["loc_id", "strategy"] },
  create_item: { params: ["item_name", "target_location", "item_icon_name", "item_image_path"] },
  update_item_details: {
    params: [
      "item_id",
      "item_name",
